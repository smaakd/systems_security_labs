...
const char *http_request_line(int fd, char *reqpath, char *env, size_t *env_len)
{
    ...
    warnx("DEBUG http_request_line: buf = %s",buf);
    ...
    *sp2 = '\0';
    ...
    warnx("DEBUG http_request_line: reqpath = %s",reqpath);
...
const char *http_request_headers(int fd)
{
	...
	warnx("DEBUG: buf = %s",buf);	
        ...
        *colon = '\0';
        ...
        url_decode(value, sp);
	warnx("DEBUG: url_decode of header, value = %s",value);
	// warnx("DEBUG: buf = %s",buf);
...
void http_serve(int fd, const char *name)
{
    ...
    strcat(pn, name);
    warnx("DEBUG http_serve: pn = %s",pn);
    split_path(pn);
